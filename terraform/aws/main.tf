...
module "eks_cluster" {
    ...
    workers_role_arns          = [module.eks_fargate_profile1.eks_fargate_profile_role_arn, module.eks_fargate_profile2.eks_fargate_profile_role_arn]
